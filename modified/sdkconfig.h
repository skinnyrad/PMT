...
/*added by Curran | CONFIG_MBEDTLS 
...
#define MBEDTLS_DEBUG_LEVEL_VERBOSE 1
end*/
...
/*added by Curran | ESP32 Specific*/
#define CONFIG_SPIRAM_SUPPORT 1
#define CONFIG_D0WD_PSRAM_CLK_IO 17 /*default*/
#define CONFIG_D0WD_PSRAM_CS_IO 16 /*default*/
#define CONFIG_D2WD_PSRAM_CLK_IO 9 /*default*/
#define CONFIG_D2WD_PSRAM_CS_IO 10 /*defualt*/
#define CONFIG_PICO_PSRAM_CS_IO 10 /*default*/
#define CONFIG_SPIRAM_SPIWP_SD3_PIN 7 /*default for PICO*/ 
/*note: FLASH_FREQ must be greater than or equal to SPIRAM speed. Ctrl+F the defines below to change.
*	#define CONFIG_ESPTOOLPY_FLASHFREQ_80M 1
*	#define CONFIG_ESPTOOLPY_FLASHFREQ "80m"*/
#define CONFIG_SPIRAM_SPEED_40M 1
#define CONFIG_SPIRAM_SIZE 2097152 /*2KB --UPGRADE: Try to increase to 4MB*/
/*after build success*/
...
#define CONFIG_NIMBLE_MAX_CONNECTIONS 4
#define CONFIG_NIMBLE_MAX_BONDS 3
#define CONFIG_NIMBLE_MAX_CCCDS 8
#define CONFIG_NIMBLE_L2CAP_COC_MAX_NUM 0
#define CONFIG_NIMBLE_PINNED_TO_CORE_1 1
#define CONFIG_NIMBLE_PINNED_TO_CORE 1
