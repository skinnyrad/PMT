...
QDEF(MP_QSTR_ETH_CLOCK_GPIO0_IN, (const byte*)"\xcd\xe6\x12" "ETH_CLOCK_GPIO0_IN")
QDEF(MP_QSTR_ETH_CLOCK_GPIO16_OUT, (const byte*)"\x73\xad\x14" "ETH_CLOCK_GPIO16_OUT")
QDEF(MP_QSTR_ETH_CLOCK_GPIO17_OUT, (const byte*)"\xf2\x84\x14" "ETH_CLOCK_GPIO17_OUT")
...
QDEF(MP_QSTR_clock_mode, (const byte*)"\x71\xe5\x0a" "clock_mode")
...
QDEF(MP_QSTR_example, (const byte*)"\xed\xcf\x07" "example")
